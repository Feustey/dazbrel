    ...
    pub fn check_rate_limit(&self, client_key: &str) -> bool {
        ...
        match entries.get_mut(client_key) {
            ...
            None => {
                ...
                entries.insert(client_key.to_string(), RateLimitEntry {
                    count: 1,
                    window_start: now,
                });
                true
...
pub async fn rate_limit_middleware(
    ...
    let allowed = RATE_LIMITER.with(|limiter| {
...
mod tests {
    ...
    fn test_rate_limit_within_limit() {
        ...
        for i in 1..=5 {
            assert!(state.check_rate_limit("test_client"), "Request {} should pass", i);
        }
    }
    ...
    fn test_rate_limit_exceeded() {
        ...
        assert!(!state.check_rate_limit("test_client"), "Request 4 should be blocked");
    }
