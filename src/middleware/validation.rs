...
impl Default for InputValidator {
    fn default() -> Self {
        ...
        rules.insert("recommendation_id".to_string(), ValidationRule {
            min_length: Some(1),
            max_length: Some(100),
        ...
        rules.insert("pubkey".to_string(), ValidationRule {
            min_length: Some(66),
            max_length: Some(68),
        ...
        rules.insert("channel_id".to_string(), ValidationRule {
            min_length: Some(1),
            max_length: Some(50),
...
impl InputValidator {
    ...
    pub fn validate_numeric(&self, field_name: &str, value: f64) -> Result<(), InputValidationError> {
        if let Some(rule) = self.rules.get(field_name) {
    ...
    fn check_security_threats(&self, value: &str) -> Result<(), InputValidationError> {
        ...
        let xss_patterns = ["<script", "</script>", "javascript:", "onload=", "onerror=", "onclick="];
...
mod tests {
    ...
    fn test_invalid_pubkey() {
        ...
        assert!(validate_input("pubkey", "02a1b2c3d4e5f6789abcdef123456789abcdef123456789abcdef123456789abcdefff").is_err()); // Too long
        assert!(validate_input("pubkey", "invalid_characters_in_pubkey_!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!").is_err());
    }
